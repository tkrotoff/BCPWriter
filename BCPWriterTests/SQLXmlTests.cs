...
namespace BCPWriter.Tests
{
    ...
    class SQLXmlTests
    {
        ...
        {
            const string myFileName = "xml_null.bcp";
        ...
        public void Test_test1_xml()
        {
            ...
            const string myFileName = "SQLXmlTest1.bcp";
        ...
        public void Test_test2_xml()
        {
            ...
            const string myFileName = "SQLXmlTest2.bcp";
            WriteXml(xml, myFileName);
            BCPTests.CheckFile(myFileName);
        }
        ...
        public void Test_test3_xml()
        {
            ...
            const string myFileName = "SQLXmlTest3.bcp";
            WriteXml(xml, myFileName);
            BCPTests.CheckFile(myFileName);
        }
        ...
        public void Test_test4_xml()
        {
            ...
            const string myFileName = "SQLXmlTest4.bcp";
            WriteXml(xml, myFileName);
            BCPTests.CheckFile(myFileName);
        }
        ...
        {
            const string xml = "<?xml version=\"1.0\" encoding=\"utf-8\"?><Header Table=\"HoldingData\" User=\"CRED-TS\" Name=\"90GIFD\" Date=\"20060329\" Type=\"HOLDINGS\" ContentsType=\"XML\" Modifier=\"GB\" Action=\"ADD\" />";

            const string myFileName = "xmldeclaration1.bcp";
            WriteXml(xml, myFileName);
            BCPTests.CheckFile(myFileName);
        }
        ...
        {
            const string xml = "<?xml version=\"1.0\"?><Header Table=\"HoldingData\" User=\"CRED-TS\" Name=\"90GIFD\" Date=\"20060329\" Type=\"HOLDINGS\" ContentsType=\"XML\" Modifier=\"GB\" Action=\"ADD\" />";

            const string myFileName = "xmldeclaration2.bcp";
            WriteXml(xml, myFileName);
            BCPTests.CheckFile(myFileName);
        }
